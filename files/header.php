        ...
        <header class="shadow-sm">
            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="<?= url('') ?>"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="<?= BASE_URL ?>"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                                                <div class="text-center py-4">
                                                    <i class="ci-cart mb-2 text-muted" style="font-size: 2.5rem; opacity: 0.5;"></i>
                                                    <p class="fs-sm text-muted mb-0">Your shopping cart is empty</p>
                                                </div>
                                                <hr class="my-2">
                                                ...
                                                <a class="btn btn-primary btn-sm d-block w-100 disabled" href="javascript:;" tabindex="-1" aria-disabled="true">
